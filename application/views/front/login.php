...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:15:36 GMT -->
    ...
    <main>
        ...
        <section class="tp-login-area pb-140 p-relative z-index-1 fix">
            <div class="tp-login-shape">
                <img class="tp-login-shape-1" src="assets_front/img/login/login-shape-1.png" alt="">
                <img class="tp-login-shape-2" src="assets_front/img/login/login-shape-2.png" alt="">
                <img class="tp-login-shape-3" src="assets_front/img/login/login-shape-3.png" alt="">
                <img class="tp-login-shape-4" src="assets_front/img/login/login-shape-4.png" alt="">
            </div>
            <div class="container">
                        ...
                        <div class="tp-login-wrapper">
                            ...
                            <div class="tp-login-option">
                                ...
                                <div class="tp-login-bottom">
                                    <button type="submit" href="" class="tp-login-btn w-100">Login</button>
                                </div>
                            </div>
                        </div>
                    </div>
