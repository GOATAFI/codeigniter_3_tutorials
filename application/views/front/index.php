                           ...
                           <div class="row align-items-center">
                              ...
                              <div class="col-xl-7 col-lg-6 col-md-6">
                                 <div class="tp-slider-thumb text-end">
                                    <img src="uploads/banner/<?= $bann->bann_image ?>" alt="slider-img">
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="tp-product-category-item text-center mb-40">
                           <div class="tp-product-category-thumb fix">
                              <a href="shop-category.html">
                                 <img src="uploads/category/<?= $cate->image ?>" alt="product-category">
                              </a>
                           </div>
                           <div class="tp-product-category-content">
                              <h3 class="tp-product-category-title">
                                 <a href="shop-category.html"><?= $cate->cate_name ?></a>
                              </h3>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-sm-6">
                                       <div class="tp-product-item p-relative transition-3 mb-25">
                                          <div class="tp-product-category">
                                             <a href="product/<?= $arr->slug; ?>"><?= $cate_name ?> (ID: <?= $arr->category ?>)</a>
                                          </div>
                                          <div class="tp-product-thumb p-relative fix m-img">
                                             <a href="product/<?= $arr->slug; ?>">
                                                <img src="uploads/products/<?= $arr->pro_main_image; ?>" alt="product-electronic">
                                             </a>
                                          ...
                                          <div class="tp-product-content">
                                             ...
                                             <div class="tp-product-price-wrapper">
                                                <span class="tp-product-price old-price">$<?= $arr->mrp; ?></span>
                                                <span class="tp-product-price new-price">$<?= $arr->selling_price; ?></span>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                              ...
                              <div class="col-xl-3 col-lg-3 col-sm-6">
                                 <div class="tp-product-item transition-3 mb-25">
                                    ...
                                    <div class="tp-product-content">
                                       ...
                                       <h3 class="tp-product-title">
                                          <a href="product-details.html">
                                             Camera 4K Digital Video Camera.
                                          </a>
                                       </h3>
                                       <div class="tp-product-rating d-flex align-items-center">
                                          <div class="tp-product-rating-icon">
